...
First we define the \verb|Cost| trait itself:
\begin{minted}{rust}
trait Cost {
    fn cost(&self) -> usize;
}
...
We can first make the Output type of the addition of two \verb|T|s variable, by giving the output type the name \verb|Tout|:
\begin{minted}{rust}
